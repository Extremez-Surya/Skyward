...
import { Moon, Sun, ShieldCheck, ChevronRight, X, Menu, Globe, MessageSquare, Share2, MapPin, Mail } from "lucide-react";
...
function Header() {
  ...
  return /* @__PURE__ */ jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? "bg-background/90 backdrop-blur-xl border-b border-border py-4 shadow-sm" : "bg-transparent py-6"}`,
      children: [
        ...
        mobileMenuOpen && /* @__PURE__ */ jsxs("div", { className: "lg:hidden absolute top-full left-0 right-0 bg-background border-b border-border shadow-2xl py-8 px-6 flex flex-col gap-6 animate-fade-up", children: [
          navLinks.map((link) => /* @__PURE__ */ jsx(
            "a",
            {
              href: link.href,
              className: "text-lg font-bold text-text-primary py-2 hover:text-primary-600 transition-colors",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 mt-4", children: [
            ...
            isLoaded && isSignedIn && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "flex justify-center py-4", children: /* @__PURE__ */ jsx(UserButton, { afterSignOutUrl: "/" }) })
            ] })
          ] })
        ] })
      ]
