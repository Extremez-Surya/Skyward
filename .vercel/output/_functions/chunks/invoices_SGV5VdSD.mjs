...
const $$Invoices = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DashboardLayout", $$DashboardLayout, { "title": "Invoices", "role": profile.role }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="p-12 bg-surface border border-surface/50 rounded-2xl text-center"> <p class="text-text-muted">This module is under development.</p> </div> ` })}`;
}, "D:/skyward/src/pages/hr/invoices.astro", void 0);
const $$file = "D:/skyward/src/pages/hr/invoices.astro";
const $$url = "/hr/invoices";
