...
function Header() {
  ...
  return /* @__PURE__ */ jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/80 backdrop-blur-md border-b border-surface/50 py-4" : "bg-transparent py-6"}`,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxs("a", { href: "/", className: "flex items-center gap-2 group", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-primary rounded-xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300", children: /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xl font-bold tracking-tight", children: "Skyward HR" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-4", children: [
            isLoaded && !isSignedIn && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("a", { href: "/sign-in", className: "text-sm font-medium text-text-main hover:text-primary transition-colors", children: "Login" }),
              /* @__PURE__ */ jsxs(
                "a",
                {
                  href: "/contact",
            ...
            isLoaded && isSignedIn && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("a", { href: "/dashboard", className: "text-sm font-medium text-text-main hover:text-primary transition-colors", children: "Dashboard" }),
        ...
        mobileMenuOpen && /* @__PURE__ */ jsxs("div", { className: "md:hidden absolute top-full left-0 right-0 bg-surface border-b border-surface-hover shadow-xl py-4 px-4 flex flex-col gap-4", children: [
...
function Footer() {
  return /* @__PURE__ */ jsx("footer", { className: "bg-surface border-t border-surface-hover pt-16 pb-8 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxs("a", { href: "/", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "w-8 h-8 bg-primary rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
            /* @__PURE__ */ jsx("path", { d: "M12 2L2 7L12 12L22 7L12 2Z", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsx("path", { d: "M2 17L12 22L22 17", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsx("path", { d: "M2 12L12 17L22 12", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
          ] }) }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-text-muted text-sm leading-relaxed", children: "A Workforce Management Platform that helps businesses deploy, manage, track, and scale manpower efficiently through technology-driven staffing solutions." }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mt-2", children: [
          /* @__PURE__ */ jsx("a", { href: "mailto:contact@skywardhr.com", className: "w-10 h-10 rounded-full bg-background flex items-center justify-center text-text-muted hover:text-primary transition-colors border border-surface-hover hover:border-primary/50", children: /* @__PURE__ */ jsx(Mail, { size: 18 }) }),
          /* @__PURE__ */ jsx("a", { href: "/contact", className: "w-10 h-10 rounded-full bg-background flex items-center justify-center text-text-muted hover:text-primary transition-colors border border-surface-hover hover:border-primary/50", children: /* @__PURE__ */ jsx(Phone, { size: 18 }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-text-main", children: "Company" }),
        /* @__PURE__ */ jsx("ul", { className: "flex flex-col gap-3", children: ["About Us", "Services", "Industries", "How it Works", "Careers", "Contact"].map((link) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: `/${link.toLowerCase().replace(/\s+/g, "-")}`, className: "text-sm text-text-muted hover:text-primary transition-colors", children: link }) }, link)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-text-main", children: "Services" }),
        /* @__PURE__ */ jsx("ul", { className: "flex flex-col gap-3", children: ["Logistics Staffing", "Warehouse Staffing", "Retail Staffing", "Office Support", "Housekeeping", "Supervisory Staff"].map((link) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "/services", className: "text-sm text-text-muted hover:text-primary transition-colors", children: link }) }, link)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-text-main", children: "Contact Us" }),
        /* @__PURE__ */ jsxs("ul", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3 text-sm text-text-muted", children: [
            /* @__PURE__ */ jsx(MapPin, { size: 18, className: "text-primary shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsx("span", { children: "123 Business Avenue, Tech Park, Metropolis 500012" })
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-3 text-sm text-text-muted", children: [
            /* @__PURE__ */ jsx(Phone, { size: 18, className: "text-primary shrink-0" }),
            /* @__PURE__ */ jsx("span", { children: "+91 98765 43210" })
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-3 text-sm text-text-muted", children: [
            /* @__PURE__ */ jsx(Mail, { size: 18, className: "text-primary shrink-0" }),
            /* @__PURE__ */ jsx("span", { children: "contact@skywardhr.com" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "pt-8 border-t border-surface-hover flex flex-col md:flex-row items-center justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
        /* @__PURE__ */ jsx("a", { href: "/privacy-policy", className: "text-sm text-text-muted hover:text-primary transition-colors", children: "Privacy Policy" }),
        /* @__PURE__ */ jsx("a", { href: "/terms-of-service", className: "text-sm text-text-muted hover:text-primary transition-colors", children: "Terms of Service" })
      ] })
    ] })
  ] }) });
}
