...
function Hero() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-background", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container-custom relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          variants: container,
          ...
          children: [
            /* @__PURE__ */ jsxs(
              ...
              {
                variants: item,
                className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-600/10 border border-primary-600/20 mb-8",
                children: [
                  /* @__PURE__ */ jsx(TrendingUp, { size: 14, className: "text-primary-600" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-primary-600 uppercase tracking-wider", children: "Enterprise Workforce 2026" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              ...
              {
                variants: item,
                className: "text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-text-primary mb-6 text-balance leading-[1.1]",
                children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                variants: item,
                className: "max-w-xl text-lg md:text-xl text-text-secondary mb-10 leading-relaxed",
                ...
                children: [
                  /* @__PURE__ */ jsx(
                    Button,
                    {
                      ...
                      className: "w-full sm:w-auto shadow-lg shadow-primary-600/20",
                  ...
                  /* @__PURE__ */ jsx(
                    Button,
                    {
                      ...
                      size: "md",
                      onClick: () => window.location.href = "/contact",
                      className: "w-full sm:w-auto border-border text-text-primary hover:bg-surface",
            ...
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-text-primary", children: "500+" }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-text-muted uppercase tracking-widest", children: "Clients" })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "w-px h-10 bg-border hidden sm:block" }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-text-primary", children: "15k+" }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-text-muted uppercase tracking-widest", children: "Staff" })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "w-px h-10 bg-border hidden sm:block" }),
